...
// Provider, Tool, ToolRegistry, SearchProvider, Approver, Compactor and
// TokenStore. Concrete implementations (adapters) live in sub-packages and
// depend on the core, never the other way around:
//
